...
<body>
	<div id="update page"></div>

	<br>
	<article id="main">

		<header class="special container">
			<h3 id="update" style="color: #7c8081 !important">나의 정보 수정</h3>
			<p id="update">정보 수정을 위해 아래 양식을 작성해주세요.</p>
		</header>
				...
				<form action="customercontroller" method="post">
					...
					<div class="row 60%">
						<div class="6u 12u(mobile)">
							<input type="text" id="inputid" value="${sessionScope.name}"
					...
					<div class="row 60%">
						<div class="12u">
							<input type="number" name="phone"
								placeholder="Phone Number('-'없이 입력)" />
						</div>
					</div>
					<div class="row 60%">
						<div class="12u">
					...
					<div class="row">
						<div class="12u" style="text-align: center;padding-bottom: 1em; padding-top: 1em;">
							<input id="complete" type="submit" class="special" value="수정완료" />
						</div>
					</div>
				</form>
